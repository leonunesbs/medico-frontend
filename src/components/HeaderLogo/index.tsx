...
import { Icon, useTheme, Button, useBreakpointValue } from '@chakra-ui/react';
import NextLink from 'next/link';
import { IHeaderLogo } from './HeaderLogo';

// const LogoNoText = ({ theme }: any) => (
//   <g id="logo-light-notext">
//     <path
//       id="N"
//       fill={theme.colors.brand[700]}
//       d="M122,119.22a2.19,2.19,0,0,1-2.2,2.2h-12a2.2,2.2,0,0,1-2.08-1.46L75.48,33.17a2.2,2.2,0,0,0-4.27.85q.51,10.62.51,19.82v49.8H57.43L57.4,44,77.28.39Z"
//     />
//     <path
//       id="L"
...
const Logo = ({ theme }: any) => (
  <g id="logo-light">
    ...
    <path
      ...
      d="M72.92.29,73.06,0H58.28a2.19,2.19,0,0,0-2,1.25L.22,118.88a2.19,2.19,0,0,0,2,3.14l67.06.24a2.18,2.18,0,0,0,2.19-2.19V108.25l-48.47,0Z"
    />
    <rect fill={theme.colors.brand[700]} x="191.42" width="2" height="123" />
    <path
      fill={theme.colors.brand[500]}
...
export const HeaderLogo: React.FunctionComponent<IHeaderLogo.IProps> = ({
  ...
  return (
    <NextLink href="/" as="/">
      ...
      >
        <Icon
          viewBox={disclosure.isOpen ? '0 0 408 123' : logoVariant}
          w="200"
          maxW={['190px', '408px']}
          h="100%"
        >
